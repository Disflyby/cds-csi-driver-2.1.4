...
StorageClass must set both `csi.storage.k8s.io/provisioner-secret-*` and
`csi.storage.k8s.io/node-publish-secret-*`; credentials are not stored in the generated PV.
